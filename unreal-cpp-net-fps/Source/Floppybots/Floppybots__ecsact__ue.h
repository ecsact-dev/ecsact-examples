...
constexpr auto FloppybotsSystemLikeIds = std::array<ecsact_system_like_id, 16>{
	...
	static_cast<
		ecsact_system_like_id>(18 /* floppybots.FinishPush.PushEntities */),
...
struct FFloppybotsPushing {
	...
	UPROPERTY(
		EditAnywhere,
		BlueprintReadWrite,
		Meta = (ClampMin = "-32768", ClampMax = "32767")
	)
	int32 TickTotal;
	UPROPERTY(
		EditAnywhere,
...
struct FFloppybotsToggle {
	...
	UPROPERTY(
		EditAnywhere,
		BlueprintReadWrite,
		Meta = (ClampMin = "-128", ClampMax = "127")
	)
	int32 Streaming;
};
...
UCLASS(
	Abstract,
	Blueprintable,
	meta = (DisplayName = "Ecsact Runner Package Subsystem (floppybots)")
)
...
protected:
	void InitComponentRaw(ecsact_entity_id, ecsact_component_id, const void*)
		override;
	void UpdateComponentRaw(ecsact_entity_id, ecsact_component_id, const void*)
		override;
	void RemoveComponentRaw(ecsact_entity_id, ecsact_component_id, const void*)
		override;
...
public:
	...
	UFUNCTION(
		...
		Category = "Ecsact Runner",
		meta = (DisplayName = "Init floppybots.Player")
	)
	...
	UFUNCTION(
		BlueprintNativeEvent,
		Category = "Ecsact Runner",
		meta = (DisplayName = "Update floppybots.Player")
	)
	...
	UFUNCTION(
		BlueprintNativeEvent,
		Category = "Ecsact Runner",
		meta = (DisplayName = "Remove floppybots.Player")
	)
	void         RemovePlayer(int32 Entity, FFloppybotsPlayer Player);
	virtual void RemovePlayer_Implementation(
		int32             Entity,
		FFloppybotsPlayer Player
	);
	UFUNCTION(
		BlueprintNativeEvent,
		Category = "Ecsact Runner",
		meta = (DisplayName = "Init floppybots.Pusher")
	)
	void         InitPusher(int32 Entity, FFloppybotsPusher Pusher);
	virtual void InitPusher_Implementation(
		int32             Entity,
	...
	UFUNCTION(
		BlueprintNativeEvent,
		Category = "Ecsact Runner",
		meta = (DisplayName = "Update floppybots.Pusher")
	)
	void         UpdatePusher(int32 Entity, FFloppybotsPusher Pusher);
	virtual void UpdatePusher_Implementation(
		int32             Entity,
		FFloppybotsPusher Pusher
	);
	UFUNCTION(
		BlueprintNativeEvent,
		Category = "Ecsact Runner",
		meta = (DisplayName = "Remove floppybots.Pusher")
	)
	void         RemovePusher(int32 Entity, FFloppybotsPusher Pusher);
	virtual void RemovePusher_Implementation(
		int32             Entity,
		FFloppybotsPusher Pusher
	);
	UFUNCTION(
		BlueprintNativeEvent,
		Category = "Ecsact Runner",
		meta = (DisplayName = "Init floppybots.PusherExpired")
	)
	void InitPusherexpired(int32 Entity, FFloppybotsPusherexpired Pusherexpired);
	virtual void InitPusherexpired_Implementation(
		int32                    Entity,
	...
	UFUNCTION(
		BlueprintNativeEvent,
		Category = "Ecsact Runner",
		meta = (DisplayName = "Update floppybots.PusherExpired")
	)
	void UpdatePusherexpired(
		int32                    Entity,
		FFloppybotsPusherexpired Pusherexpired
	);
	virtual void UpdatePusherexpired_Implementation(
		int32                    Entity,
		FFloppybotsPusherexpired Pusherexpired
	);
	UFUNCTION(
		BlueprintNativeEvent,
		Category = "Ecsact Runner",
		meta = (DisplayName = "Remove floppybots.PusherExpired")
	)
	void RemovePusherexpired(
		int32                    Entity,
		FFloppybotsPusherexpired Pusherexpired
	);
	virtual void RemovePusherexpired_Implementation(
		int32                    Entity,
		FFloppybotsPusherexpired Pusherexpired
	);
	UFUNCTION(
		BlueprintNativeEvent,
		Category = "Ecsact Runner",
		meta = (DisplayName = "Init floppybots.Rotation")
	)
	void         InitRotation(int32 Entity, FFloppybotsRotation Rotation);
	virtual void InitRotation_Implementation(
		int32               Entity,
	...
	UFUNCTION(
		BlueprintNativeEvent,
		Category = "Ecsact Runner",
		meta = (DisplayName = "Update floppybots.Rotation")
	)
	void         UpdateRotation(int32 Entity, FFloppybotsRotation Rotation);
	virtual void UpdateRotation_Implementation(
		int32               Entity,
		FFloppybotsRotation Rotation
	);
	UFUNCTION(
		BlueprintNativeEvent,
		Category = "Ecsact Runner",
		meta = (DisplayName = "Remove floppybots.Rotation")
	)
	void         RemoveRotation(int32 Entity, FFloppybotsRotation Rotation);
	virtual void RemoveRotation_Implementation(
		int32               Entity,
		FFloppybotsRotation Rotation
	);
	UFUNCTION(
		BlueprintNativeEvent,
		Category = "Ecsact Runner",
		meta = (DisplayName = "Init floppybots.Position")
	)
	void         InitPosition(int32 Entity, FFloppybotsPosition Position);
	virtual void InitPosition_Implementation(
		int32               Entity,
	...
	UFUNCTION(
		BlueprintNativeEvent,
		Category = "Ecsact Runner",
		meta = (DisplayName = "Update floppybots.Position")
	)
	void         UpdatePosition(int32 Entity, FFloppybotsPosition Position);
	virtual void UpdatePosition_Implementation(
		int32               Entity,
		FFloppybotsPosition Position
	);
	UFUNCTION(
		BlueprintNativeEvent,
		Category = "Ecsact Runner",
		meta = (DisplayName = "Remove floppybots.Position")
	)
	void         RemovePosition(int32 Entity, FFloppybotsPosition Position);
	virtual void RemovePosition_Implementation(
		int32               Entity,
		FFloppybotsPosition Position
	);
	UFUNCTION(
		BlueprintNativeEvent,
		Category = "Ecsact Runner",
		meta = (DisplayName = "Init floppybots.Stunned")
	)
	void         InitStunned(int32 Entity, FFloppybotsStunned Stunned);
	virtual void InitStunned_Implementation(
		int32              Entity,
	...
	UFUNCTION(
		BlueprintNativeEvent,
		Category = "Ecsact Runner",
		meta = (DisplayName = "Update floppybots.Stunned")
	)
	void         UpdateStunned(int32 Entity, FFloppybotsStunned Stunned);
	virtual void UpdateStunned_Implementation(
		int32              Entity,
		FFloppybotsStunned Stunned
	);
	UFUNCTION(
		BlueprintNativeEvent,
		Category = "Ecsact Runner",
		meta = (DisplayName = "Remove floppybots.Stunned")
	)
	void         RemoveStunned(int32 Entity, FFloppybotsStunned Stunned);
	virtual void RemoveStunned_Implementation(
		int32              Entity,
		FFloppybotsStunned Stunned
	);
	UFUNCTION(
		BlueprintNativeEvent,
		Category = "Ecsact Runner",
		meta = (DisplayName = "Init floppybots.StunnedExpired")
	)
	void InitStunnedexpired(
		int32                     Entity,
		FFloppybotsStunnedexpired Stunnedexpired
	);
	virtual void InitStunnedexpired_Implementation(
		int32                     Entity,
		FFloppybotsStunnedexpired Stunnedexpired
	);
	UFUNCTION(
		BlueprintNativeEvent,
		Category = "Ecsact Runner",
		meta = (DisplayName = "Update floppybots.StunnedExpired")
	)
	void UpdateStunnedexpired(
		int32                     Entity,
		FFloppybotsStunnedexpired Stunnedexpired
	);
	virtual void UpdateStunnedexpired_Implementation(
		int32                     Entity,
		FFloppybotsStunnedexpired Stunnedexpired
	);
	UFUNCTION(
		BlueprintNativeEvent,
		Category = "Ecsact Runner",
		meta = (DisplayName = "Remove floppybots.StunnedExpired")
	)
	void RemoveStunnedexpired(
		int32                     Entity,
		FFloppybotsStunnedexpired Stunnedexpired
	);
	virtual void RemoveStunnedexpired_Implementation(
		int32                     Entity,
		FFloppybotsStunnedexpired Stunnedexpired
	);
	UFUNCTION(
		BlueprintNativeEvent,
		Category = "Ecsact Runner",
		meta = (DisplayName = "Init floppybots.PushCharge")
	)
	void         InitPushcharge(int32 Entity, FFloppybotsPushcharge Pushcharge);
	virtual void InitPushcharge_Implementation(
		int32                 Entity,
	...
	UFUNCTION(
		BlueprintNativeEvent,
		Category = "Ecsact Runner",
		meta = (DisplayName = "Update floppybots.PushCharge")
	)
	void         UpdatePushcharge(int32 Entity, FFloppybotsPushcharge Pushcharge);
	virtual void UpdatePushcharge_Implementation(
		int32                 Entity,
		FFloppybotsPushcharge Pushcharge
	);
	UFUNCTION(
		BlueprintNativeEvent,
		Category = "Ecsact Runner",
		meta = (DisplayName = "Remove floppybots.PushCharge")
	)
	void         RemovePushcharge(int32 Entity, FFloppybotsPushcharge Pushcharge);
	virtual void RemovePushcharge_Implementation(
		int32                 Entity,
		FFloppybotsPushcharge Pushcharge
	);
	UFUNCTION(
		BlueprintNativeEvent,
		Category = "Ecsact Runner",
		meta = (DisplayName = "Init floppybots.Enemy")
	)
	...
	UFUNCTION(
		BlueprintNativeEvent,
		Category = "Ecsact Runner",
		meta = (DisplayName = "Update floppybots.Enemy")
	)
	...
	UFUNCTION(
		BlueprintNativeEvent,
		Category = "Ecsact Runner",
		meta = (DisplayName = "Remove floppybots.Enemy")
	)
	...
	UFUNCTION(
		BlueprintNativeEvent,
		Category = "Ecsact Runner",
		meta = (DisplayName = "Init floppybots.Velocity")
	)
	void         InitVelocity(int32 Entity, FFloppybotsVelocity Velocity);
	virtual void InitVelocity_Implementation(
		int32               Entity,
	...
	UFUNCTION(
		BlueprintNativeEvent,
		Category = "Ecsact Runner",
		meta = (DisplayName = "Update floppybots.Velocity")
	)
	void         UpdateVelocity(int32 Entity, FFloppybotsVelocity Velocity);
	virtual void UpdateVelocity_Implementation(
		int32               Entity,
		FFloppybotsVelocity Velocity
	);
	UFUNCTION(
		BlueprintNativeEvent,
		Category = "Ecsact Runner",
		meta = (DisplayName = "Remove floppybots.Velocity")
	)
	void         RemoveVelocity(int32 Entity, FFloppybotsVelocity Velocity);
	virtual void RemoveVelocity_Implementation(
		int32               Entity,
		FFloppybotsVelocity Velocity
	);
	UFUNCTION(
		BlueprintNativeEvent,
		Category = "Ecsact Runner",
		meta = (DisplayName = "Init floppybots.Pushing")
	)
	void         InitPushing(int32 Entity, FFloppybotsPushing Pushing);
	virtual void InitPushing_Implementation(
		int32              Entity,
	...
	UFUNCTION(
		BlueprintNativeEvent,
		Category = "Ecsact Runner",
		meta = (DisplayName = "Update floppybots.Pushing")
	)
	void         UpdatePushing(int32 Entity, FFloppybotsPushing Pushing);
	virtual void UpdatePushing_Implementation(
		int32              Entity,
		FFloppybotsPushing Pushing
	);
	UFUNCTION(
		BlueprintNativeEvent,
		Category = "Ecsact Runner",
		meta = (DisplayName = "Remove floppybots.Pushing")
	)
	void         RemovePushing(int32 Entity, FFloppybotsPushing Pushing);
	virtual void RemovePushing_Implementation(
		int32              Entity,
		FFloppybotsPushing Pushing
	);
	UFUNCTION(
		BlueprintNativeEvent,
		Category = "Ecsact Runner",
		meta = (DisplayName = "Init floppybots.Toggle")
	)
	void         InitToggle(int32 Entity, FFloppybotsToggle Toggle);
	virtual void InitToggle_Implementation(
		int32             Entity,
	...
	UFUNCTION(
		BlueprintNativeEvent,
		Category = "Ecsact Runner",
		meta = (DisplayName = "Update floppybots.Toggle")
	)
	void         UpdateToggle(int32 Entity, FFloppybotsToggle Toggle);
	virtual void UpdateToggle_Implementation(
		int32             Entity,
		FFloppybotsToggle Toggle
	);
	UFUNCTION(
		BlueprintNativeEvent,
		Category = "Ecsact Runner",
		meta = (DisplayName = "Remove floppybots.Toggle")
	)
	void         RemoveToggle(int32 Entity, FFloppybotsToggle Toggle);
	virtual void RemoveToggle_Implementation(
		int32             Entity,
		FFloppybotsToggle Toggle
	);
	UFUNCTION(
		BlueprintNativeEvent,
		Category = "Ecsact Runner",
		meta = (DisplayName = "Init floppybots.MoveDirection")
	)
	void InitMovedirection(int32 Entity, FFloppybotsMovedirection Movedirection);
	virtual void InitMovedirection_Implementation(
		int32                    Entity,
	...
	UFUNCTION(
		BlueprintNativeEvent,
		Category = "Ecsact Runner",
		meta = (DisplayName = "Update floppybots.MoveDirection")
	)
	void UpdateMovedirection(
		int32                    Entity,
		FFloppybotsMovedirection Movedirection
	);
	virtual void UpdateMovedirection_Implementation(
		int32                    Entity,
		FFloppybotsMovedirection Movedirection
	);
	UFUNCTION(
		BlueprintNativeEvent,
		Category = "Ecsact Runner",
		meta = (DisplayName = "Remove floppybots.MoveDirection")
	)
	void RemoveMovedirection(
		int32                    Entity,
		FFloppybotsMovedirection Movedirection
	);
	virtual void RemoveMovedirection_Implementation(
		int32                    Entity,
		FFloppybotsMovedirection Movedirection
	);
	UFUNCTION(
		BlueprintNativeEvent,
		Category = "Ecsact Runner",
		meta = (DisplayName = "Init floppybots.RemovePushingTag")
	)
	void InitRemovepushingtag(
		int32                       Entity,
		FFloppybotsRemovepushingtag Removepushingtag
	);
	virtual void InitRemovepushingtag_Implementation(
		int32                       Entity,
		FFloppybotsRemovepushingtag Removepushingtag
	);
	UFUNCTION(
		BlueprintNativeEvent,
		Category = "Ecsact Runner",
		meta = (DisplayName = "Update floppybots.RemovePushingTag")
	)
	void UpdateRemovepushingtag(
		int32                       Entity,
		FFloppybotsRemovepushingtag Removepushingtag
	);
	virtual void UpdateRemovepushingtag_Implementation(
		int32                       Entity,
		FFloppybotsRemovepushingtag Removepushingtag
	);
	UFUNCTION(
		BlueprintNativeEvent,
		Category = "Ecsact Runner",
		meta = (DisplayName = "Remove floppybots.RemovePushingTag")
	)
	void RemoveRemovepushingtag(
		int32                       Entity,
		FFloppybotsRemovepushingtag Removepushingtag
	);
	virtual void RemoveRemovepushingtag_Implementation(
		int32                       Entity,
		FFloppybotsRemovepushingtag Removepushingtag
	);
};
